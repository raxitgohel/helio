// Inline SVG icons (no emoji anywhere in the UI). Line icons inherit the text
// color via currentColor; play/pause are filled. Returns an SVG markup string.
const PATHS = {
...
const FILLED = new Set(["play", "pause", "rewind", "forward", "sparkle"]);
